    ...
    <>
      ...
      <FaqContainer>
        ...
        <Section question="Is FNS only for storing a Fantom address?">
          ...
          content hash of a decentralized website, profile information such as
          an avatar and Twitter handle, and more.
        </Section>

        <Section question="Can I use an FNS name to point to my website?">
          Though FNS can technically store anything, there aren't many third
          ...
          put the hash in your FNS name's Content record. Then it can be
          resolved by FNS-aware browsers (e.g. Opera), browser extensions
          (Metamask), or any browser with ".link" appended to the end (e.g.
          matoken.ftm.link).
          <br />
          If you want to redirect your FNS name to an existing website, you
          ...
          your contenthash. See the source code of depositcontract.ftm.link as
          an example.
        </Section>
        ...
        <Section question="Can I register names other than .ftm?" last={true}>
          ...
          <a href="/name/[root]/subdomains"> here </a>
          , you can use the DNS record as the proof to claim the equivalent FNS
          names.
          <br />
          Please refer to our{' '}
          <a href="https://docs.fantom.foundation/">guide</a> for more detail.
        </Section>
        ...
        <Section question="What is a Reverse Record?">
          ...
          allows dapps to find and display your FNS name when you connect to
          them with your Fantom account. This can only be set by you so it is
        ...
        <Section question="How do I receive a renewal reminder?">
          ...
          can register a name for multiple years, removing the need to renew
          each year.
        </Section>
